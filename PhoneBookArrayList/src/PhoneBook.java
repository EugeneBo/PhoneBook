...
public class PhoneBook {
    ...
    private static Contact contactDataInput() {
        ...
        return new Contact(name, phone, email); //создание объекта через конструктор
    }
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("\nCONTACTS COUNT :" + newContactList.size());
            ...
            if (menuInput == 1) { //упорядоченное добавление контактов
                ...
                if (newContactList.size() == 0) {
                    ...
                    if (index < 0 || index > newContactList.size()) {
                        System.out.println("\nOUT OF BOUNDS!");
...
5) Инициализирую объект Contact через конструктор. Нужно ли?
